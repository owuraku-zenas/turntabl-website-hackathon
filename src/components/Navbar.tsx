            ...
            <div className='max-w-7xl mx-auto px-2 sm:px-6 lg:px-8'>
                <div className='relative flex h-16 items-center justify-center'>
                    <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                        <button type="button" onClick={() => toggleNav()} className="inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
                    ...
                    <div className="flex w-full items-center justify-between sm:items-stretch sm:justify-start">
                        <div className="flex flex-shrink-0 items-center justify-center w-full sm:w-auto">
                            <Link href="/">
                                <img className="block h-8 w-auto lg:hidden" src="/images/TT Logo.png" alt="Your Company" />
                            ...
                            <div className="flex space-x-4 w-full justify-end">
                                ...
                                {navItems.map((item, index) => (
                                    <Link
                                        key={index}
                                        href={item.path}
                                        // className="border-b-2 border-transparent hover:border-b-2 hover:border-white hover:text-white px-3 py-2 text-sm font-bold tracking-widest"
                        ...
                        <div className="space-y-1 px-2 pb-3 pt-2">
                            {navItems.map((item, index) => (
                                <Link
                                    key={index}
                                    href={item.path}
                                    className="hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-bold"
                                >
                                    {item.name}
                                </Link>
                            ))}
